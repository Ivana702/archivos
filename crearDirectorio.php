    ...
    <div class="fondo-section">
        <div class="container section black-text">
            ...
            <div class="section">
                ...
                <h5>Creación de directorios: </h5>

                <p>Aquí se pueden crear directorios.</p>
            ...
            <form class="col s12" action="creacionDeDirectorios.php" method="POST">
                <div class="row">
                    <div class="input-field col s6">
                        ...
                        <label class="indigo-text text-lighten-1" for="input_text">Nombre del Directorio</label>
                    </div>
                </div>
                
                <button class="btn waves-effect waves-light indigo lighten-1" type="submit" name="action btnD">Crear Directorio</button>
            </form>
        </div>
    </div>
