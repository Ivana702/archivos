            ...
            <form class="col s12" action="creandoArchivos.php" method="POST">
                <div class="row">
                    <div class="input-field col s6">
                        ...
                        <label class="indigo-text text-lighten-1" for="input_text">Nombre del Archivo</label>
                    </div>
                </div>
                ...
                <button class="btn waves-effect waves-light indigo lighten-1" type="submit" name="action btn">Crear Archivo</button>
            </form>
        </div>
    </div>
